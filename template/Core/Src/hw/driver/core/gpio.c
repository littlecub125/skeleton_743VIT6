...
static gpio_tbl_t gpio_tbl[HW_GPIO_PIN_IO_MAX] = {
  ...
  { PD06_W25Q64_SPI1_CS_GPIO_O_GPIO_Port, PD06_W25Q64_SPI1_CS_GPIO_O_Pin, GPIO_TYPE_OUTPUT, GPIO_PIN_SET, "W25Q64_CS"},
  { PE08_RELAY_CTRL_GPIO_Port, PE08_RELAY_CTRL_Pin, GPIO_TYPE_OUTPUT, GPIO_PIN_RESET, "RELAY_CTRL"},
  { PA01_RC522_SPI1_CS_GPIO_O_GPIO_Port, PA01_RC522_SPI1_CS_GPIO_O_Pin, GPIO_TYPE_OUTPUT, GPIO_PIN_SET, "RC522_CS"},
  { PA02_RC522_SPI1_RST_GPIO_O_GPIO_Port, PA02_RC522_SPI1_RST_GPIO_O_Pin, GPIO_TYPE_OUTPUT, GPIO_PIN_SET, "RC522_RST"},
  { PA03_SS5GL_SW_GPIO_I_GPIO_Port, PA03_SS5GL_SW_GPIO_I_Pin, GPIO_TYPE_INPUT, GPIO_PIN_RESET, "SS5GL_SW" },
};
/* @formatter:on */
bool gpioInit(void)
{
